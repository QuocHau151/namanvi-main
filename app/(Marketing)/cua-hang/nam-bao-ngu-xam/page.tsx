      ...
      <section className="product-details space-top space-extra-bottom">
        <div className="container">
          <div className="row gx-60">
            ...
            <div className="col-lg-6 align-self-center">
              <div className="product-about">
                ...
                <h2 className="product-title">Nấm Bào Ngư Xám</h2>
                ...
                <p className="text">
                  Trong nấm có chứa rất nhiều chất dinh dưỡng có lợi cho sức
                  khỏe như protide, glucide, vitamin C, vitamin PP, acid folic
          ...
          <div className="tab-content" id="productTabContent">
            ...
            >
              <p>
                Trong nấm có chứa rất nhiều chất dinh dưỡng có lợi cho sức khỏe
                như protide, glucide, vitamin C, vitamin PP, acid folic các acid
                béo không no…
              </p>
            </div>
            <div
