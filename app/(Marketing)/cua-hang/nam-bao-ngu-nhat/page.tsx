      ...
      <section className="product-details space-top space-extra-bottom">
        <div className="container">
          <div className="row gx-60">
            ...
            <div className="col-lg-6 align-self-center">
              <div className="product-about">
                ...
                <h2 className="product-title">Nấm Bào Ngư Nhật</h2>
                ...
                <p className="text">
                  Nấm bào ngư Nhật là một trong những loại nấm tươi có chứa
                  nhiều chất dinh dưỡng có lợi cho cơ thể.
                </p>
          ...
          <div className="tab-content" id="productTabContent">
            ...
            >
              <p>
                Nấm bào ngư Nhật là một trong những loại nấm tươi có chứa nhiều
                chất dinh dưỡng có lợi cho cơ thể.
              </p>
              <p>
                Phòng các bệnh như huyết áp, chống béo phì, hỗ trợ bệnh đường
                ruột, tẩy máu xấu,… Phòng ngừa giun, sán trong cơ thể. Các
                Pleutorin có tác dụng kháng khuẩn và ngừa sự phát triển của các
                tế bào ung thư. Giảm Cholesterol, đường trong máu, mỡ máu, tiểu
                đường,… Đặc biệt Nấm Bào Ngư có thể ăn thay thịt hoàn toàn
              </p>
            </div>
            <div
