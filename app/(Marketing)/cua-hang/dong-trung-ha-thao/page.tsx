      ...
      <section className="product-details space-top space-extra-bottom">
        <div className="container">
          <div className="row gx-60">
            ...
            <div className="col-lg-6 align-self-center">
              <div className="product-about">
                ...
                <h2 className="product-title">Đông Trùng Hạ Thảo</h2>
                ...
                <p className="text">
                  Đông trùng hạ thảo có chứa những dược chất vô cùng quý hiếm có
                  khả năng giúp cơ thể phòng ngừa và hỗ trợ điều trị ung thư
                </p>
                ...
                <div className="product_meta">
                  <span className="posted_in">
                    Danh Mục: <a href="#">Đông trùng hạ thảo</a>
                  </span>
                  <span>
          ...
          <div className="tab-content" id="productTabContent">
            ...
            >
              <p>
                - Các loại vitamin A, B (B1, B2, B12,…), C, E, K,… - D-mannitol
                giúp hỗ trợ điều trị các triệu chứng phù não, thiểu niệu, bài
                tiết,…
              </p>
              <p> - Các nguyên tố vi lượng như Mn, Al, K, Na, Mg,…</p>
              <p>
                - Hàm lượng Lipid lớn giúp tạo ra các nguồn năng lượng bổ sung.
                17 loại axit amin, trong đó các loại mà cơ thể không thể tự tổng
                hợp
              </p>
              <p>
                - Hoạt chất sinh học Hydroxyethyl Adenosine giúp kháng khuẩn và
                diệt virus,…
              </p>
              <p>
                -Dinh dưỡng nhóm HEAA, Adenosine, Acid Cordyceptic,
                Carbohydrate, Monosaccharide, Sterol, Polysaccharide,…
              </p>
            </div>
            <div
