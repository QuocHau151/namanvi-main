      ...
      <section className="product-details space-top space-extra-bottom">
        <div className="container">
          <div className="row gx-60">
            ...
            <div className="col-lg-6 align-self-center">
              <div className="product-about">
                ...
                <h2 className="product-title">Nấm Linh Chi Đỏ</h2>
                ...
                <p className="text">
                  Nấm Linh Chi Đỏ là một trong những loại nấm tươi có chứa nhiều
                  chất dinh dưỡng có lợi cho cơ thể.
                </p>
                ...
                <div className="product_meta">
                  <span className="posted_in">
                    Danh Mục: <a href="#">Nấm Linh Chi Đỏ</a>
                  </span>
                  <span>
                    Từ Khoá: <a href="#">Nấm</a>
                    <a href="#">Nấm Linh Chi Đỏ</a>
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="tab-content" id="productTabContent">
            ...
            >
              <p>
                - Hỗ trợ điều trị ung thư. Chống dị ứng, chống viêm. Chống oxy
                hóa, khử các gốc tự do trong cơ thể, nâng cao hệ miễn dịch. -
                Giúp ăn ngon. Hỗ trợ điều trị bệnh đau dạ dày. Giúp ổn định
                đường huyết. Thải độc trong lá gan. - Điều hòa và ổn định huyết
                áp. Chống nhiễm mỡ xơ mạch. Giảm Cholesterol. - Chống suy nhược
                thần kinh kéo dài, giúp ngủ ngon. - Giúp cơ, xương, khớp linh
                hoat, giảm đau tứ chi, giảm viêm khớp. - Tăng cường sức đề kháng
                cơ thể.
              </p>
            </div>
            <div
